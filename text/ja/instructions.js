...
var TEXT_JA = {
  ...
  // --- Participant ID -----------------------------------------------------
  id: {
    confirm_title: 'はじめる前に',
    confirm_body:  '<p>あなたの参加者IDは次のとおりです：</p>',
    confirm_hint:  '正しければ<b>スペースキー</b>を押して進んでください。<br>' +
                   '違う場合は、このページを閉じて実験者にご連絡ください。',
    ...
    entry_title:   '参加者ID',
    entry_body:    '<p>案内メールに記載された参加者IDを入力してください。</p>',
    entry_hint:    '<code>R_</code> に続いて英数字15文字です。' +
                   '大文字と小文字は区別されます。',
    entry_label:   '参加者ID',
  ...
  contact: {
    title:       '連絡先（任意）',
    body:        '<p>本研究について連絡を受け取ってもよい場合は、' +
                 'お名前とメールアドレスをご記入ください。</p>' +
                 '<p>入力は<b>任意</b>です。連絡先は回答データとは' +
                 '別に保存されます。</p>',
    name_label:  'お名前',
    email_label: 'メールアドレス',
    button:      '次へ',
